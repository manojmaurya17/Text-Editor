...
def change_theme(event=None):
    ...
    content_text.config(
        background=background_color, fg=foreground_color,insertbackground=foreground_color)

def tab(arg):
    content_text.insert(INSERT, " " * 4)
    on_content_changed()
    return 'break'
...
content_text.bind("<Tab>",tab)
content_text.bind("<Return>",enter)
content_text.bind("<BackSpace>",backspace)
